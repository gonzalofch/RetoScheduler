...
namespace RetoSchedulerTest
{
    public class SchedulerTestSpanishTexts : IEnumerable<object[]>
    {
        public readonly List<object[]> data = new List<object[]>()
        {
            ...
            new DailyConfiguration(DailyConfigType.Recurring, TimeOnly.MinValue, 1, DailyFrecuency.Hours, new TimeLimits(new TimeOnly(3, 0, 0), new TimeOnly(6, 0, 0))), new DateLimits(new DateTime(2020, 1, 1)),Cultures.es_ES),
            ...
            new DailyConfiguration(DailyConfigType.Once, new TimeOnly(17, 0, 0), 5, DailyFrecuency.Hours, new TimeLimits(new TimeOnly(6, 0, 0), new TimeOnly(16, 0, 0))), new DateLimits(new DateTime(2020, 1, 4)),Cultures.es_ES),
            ...
            new DailyConfiguration(DailyConfigType.Once, new TimeOnly(3, 0, 0), 5, DailyFrecuency.Hours, new TimeLimits(new TimeOnly(6, 0, 0), new TimeOnly(16, 0, 0))), new DateLimits(new DateTime(2020, 1, 3)),Cultures.es_ES),
