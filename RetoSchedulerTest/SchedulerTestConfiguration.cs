    ...
    public class SchedulerTestConfiguration : IEnumerable<object[]>
    {
        public readonly List<object[]> data = new List<object[]>()
        {
            ...
            new object[]
            {
                ...
                new OutPut(new DateTime(2023,12,30,16,0,0),"Occurs every 5 days. Schedule will be used on 30/12/2023 starting on 30/12/2023")
            },
            new object[]
            {
                new Configuration
            ...
            new object[]
            {
                ...
                new OutPut(new DateTime(2023,12,24,10,0,0),"Occurs every day. Schedule will be used on 24/12/2023 starting on 27/12/2020")
            },
            new object[]
            {
                ...
                new OutPut(new DateTime(2020,1,7,14, 0, 0),"Occurs every day. Schedule will be used on 07/01/2020 starting on 07/01/2020")
            },
            new object[]
            {
                new Configuration(
                    ...
                    new OutPut(new DateTime(2020,1,9,14,0,0),"Occurs every day. Schedule will be used on 09/01/2020 starting on 09/01/2020")
            },

            new object[]
            {
                new Configuration(
                    new DateTime(2024, 4,11),ConfigType.Once,true, new DateTime(2024, 4, 11),Occurs.Daily,
                    null,
                    new DailyConfiguration(DailyConfigType.Once,new TimeOnly(16,55,55),null,null,null),
                    new DateLimits(new DateTime(2024,4,11))),
                    new OutPut(new DateTime(2024,4,11,16,55,55),"Occurs every day. Schedule will be used on 09/01/2020 starting on 09/01/2020")
            },
            new object[]
            {
                    new Configuration(
                    new DateTime(2024, 4,11,0,0,0),ConfigType.Recurring,true,null,Occurs.Daily,null,
                    ...
                    new OutPut(new DateTime(2024,4,11,8,30,55),"Occurs every day. Schedule will be used on 09/01/2020 starting on 09/01/2020")
            },

            new object[]
            {
                new Configuration(
                    new DateTime(2024, 4,11,12,46,30),ConfigType.Recurring,true,null,Occurs.Daily,
                    null,
                    new DailyConfiguration(DailyConfigType.Once,new TimeOnly(8,30,55),null,null,null),
                    new DateLimits(new DateTime(2024,4,14),new DateTime(2024,4,18))),
                    new OutPut(new DateTime(2024,4,14,8,30,55),"Occurs every day. Schedule will be used on 09/01/2020 starting on 09/01/2020")
            },
        };
